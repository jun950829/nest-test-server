...
export class EthersService {
  ...
  sendPTC(): string {
    // this.realSendPTC(this.appGateway, "PTC");
  ...
  realSendPTC(appGateway, gb: string): void {
    ...
    const senderPrivateKey =
      "0xd405ffd2180abab8803095b7027d3f92a8ad2aab52e1a3d9a3e98007da82db45"; // 여기에 실제 개인 키를 입력하세요.
